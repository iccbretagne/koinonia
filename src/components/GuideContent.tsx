...
const FEATURES: Feature[] = [
  ...
  },
  {
    ...
    description: "Depuis l'onglet « Nouveaux convertis » de /care, créé automatiquement à la réponse à l'appel au salut : confiez le suivi à un profil pastoral ou à un membre du MSDP, puis, en tant qu'accompagnant en charge, faites progresser le statut (contacté, en formation, terminé), ajoutez des notes, ou rendez le suivi au référent. Un référent peut aussi réaffecter ou rouvrir un suivi abandonné.",
    category: "Suivi pastoral",
  ...
  },
  {
    ...
    description: "Depuis /care/parametres, réglez les deux délais au-delà desquels une demande de RDV est signalée à relancer dans le bandeau « À relancer » de /care : non confiée (alerte aux référents, 7 jours par défaut) et confiée sans date fixée (alerte à l'accompagnant, 14 jours par défaut).",
    category: "Suivi pastoral",
  ...
  },
  {
    ...
    description: "Visualisez depuis /care/stats les volumes de demandes de RDV par état, par accompagnant et les motifs de rejet, ainsi que les statistiques du suivi MSDP (entonnoir, délais, jalons de parcours).",
    category: "Suivi pastoral",
