...
//
// Par email : correspondance EXACTE, sur toute la plateforme. Un compte déjà lié à
// un STAR dans une autre église n'a par définition aucun rattachement ici (ni rôle,
// ni demande) et resterait introuvable sinon — cas réel : un STAR sert dans deux
// églises. Une correspondance exacte ne permet pas d'énumérer des comptes : il faut
// déjà connaître l'adresse complète, comme pour un "inviter par email" classique.
