      ...
      <div className="bg-white rounded-xl border border-gray-200 p-5 space-y-3 mb-4">
        {followUp.assignedConseillerMsdp && (
          <p className="text-sm text-gray-600">
            Accompagnant : <strong>{followUp.assignedConseillerMsdp.name ?? followUp.assignedConseillerMsdp.email}</strong>
          </p>
        )}
        {followUp.assignedProfile && (
          <p className="text-sm text-gray-600">
            Accompagnant : <strong>{followUp.assignedProfile.name}</strong>
          </p>
        )}
